/*
 ...
 Source Schema         : sealtalk

 Target Server Type    : MySQL
 Target Server Version : 80022
 File Encoding         : 65001

 Date: 05/03/2021 17:15:21
*/
...
CREATE TABLE `data_versions` (
  `userId` bigint unsigned NOT NULL,
  `userVersion` bigint unsigned NOT NULL DEFAULT '0',
  `blacklistVersion` bigint unsigned NOT NULL DEFAULT '0',
  `friendshipVersion` bigint unsigned NOT NULL DEFAULT '0',
  `groupVersion` bigint unsigned NOT NULL DEFAULT '0',
  `groupMemberVersion` bigint unsigned NOT NULL DEFAULT '0',
  PRIMARY KEY (`userId`)
...
-- ----------------------------
-- Table structure for group_bulletins
-- ----------------------------
...
-- ----------------------------
-- Table structure for group_exited_lists
-- ----------------------------
DROP TABLE IF EXISTS `group_exited_lists`;
CREATE TABLE `group_exited_lists` (
  `id` int unsigned NOT NULL AUTO_INCREMENT,
  `groupId` char(64) NOT NULL,
  `quitUserId` bigint unsigned NOT NULL,
  ...
  `operatorId` bigint unsigned DEFAULT NULL,
...
-- ----------------------------
-- Table structure for group_favs
-- ----------------------------
...
-- ----------------------------
-- Table structure for group_receivers
-- ----------------------------
...
CREATE TABLE `groups` (
  ...
  `bulletin` text,
  `certiStatus` int unsigned NOT NULL DEFAULT '1',
  `isMute` int unsigned NOT NULL DEFAULT '0',
  `clearStatus` int unsigned NOT NULL DEFAULT '0',
  `clearTimeAt` bigint unsigned NOT NULL DEFAULT '0',
  `memberProtection` int unsigned NOT NULL DEFAULT '0',
...
-- ----------------------------
-- Table structure for screen_statuses
-- ----------------------------
...
CREATE TABLE `users` (
  ...
  `phoneVerify` int unsigned NOT NULL DEFAULT '1',
  `stSearchVerify` int unsigned NOT NULL DEFAULT '1',
  `friVerify` int unsigned NOT NULL DEFAULT '1',
  `groupVerify` int unsigned NOT NULL DEFAULT '1',
...
) ENGINE=InnoDB AUTO_INCREMENT=17812543178 DEFAULT CHARSET=utf8;
...
-- ----------------------------
-- Table structure for verification_violations
-- ----------------------------
